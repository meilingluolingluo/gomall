...
type ChargeReq struct {
	...
	Amount     float32         `protobuf:"fixed32,1,opt,name=amount,proto3" json:"amount,omitempty" form:"amount" query:"amount"`
	CreditCard *CreditCardInfo `protobuf:"bytes,2,opt,name=credit_card,json=creditCard,proto3" json:"credit_card,omitempty" form:"credit_card" query:"credit_card"`
	...
	UserId     uint32          `protobuf:"varint,4,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty" form:"user_id" query:"user_id"`
}
...
var file_payment_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x69, 0x6c, 0x69, 0x6e, 0x67, 0x6c, 0x75, 0x6f, 0x6c, 0x69, 0x6e, 0x67, 0x6c, 0x75,
