...
func TestGetpersonal(t *testing.T) {
	h := server.Default()
	h.GET("/personal", Getpersonal)
	path := "/personal"                                       // todo: you can customize query
	body := &ut.Body{Body: bytes.NewBufferString(""), Len: 1} // todo: you can customize body
	header := ut.Header{}                                     // todo: you can customize header
...
func TestUpdatePwd(t *testing.T) {
	h := server.Default()
	h.POST("/auth/update", UpdatePwd)
	path := "/auth/update"                                    // todo: you can customize query
	body := &ut.Body{Body: bytes.NewBufferString(""), Len: 1} // todo: you can customize body
	header := ut.Header{}                                     // todo: you can customize header
	w := ut.PerformRequest(h.Engine, "POST", path, body, header)
	resp := w.Result()
...
func TestDelete(t *testing.T) {
	h := server.Default()
	h.POST("/auth/delete", Delete)
	path := "/auth/delete"                                    // todo: you can customize query
	body := &ut.Body{Body: bytes.NewBufferString(""), Len: 1} // todo: you can customize body
	header := ut.Header{}                                     // todo: you can customize header
	w := ut.PerformRequest(h.Engine, "POST", path, body, header)
	resp := w.Result()
