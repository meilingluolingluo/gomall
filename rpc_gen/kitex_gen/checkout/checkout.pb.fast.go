...
func (x *PaymentInfo) fastReadField3(buf []byte, _type int8) (offset int, err error) {
	x.AlipayAuthCode, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}
...
func (x *PaymentInfo) fastWriteField1(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt32(buf[offset:], 1, int32(x.GetPaymentType()))
	return offset
}
...
func (x *PaymentInfo) fastWriteField3(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 3, x.GetAlipayAuthCode())
	return offset
}
...
func (x *CheckoutReq) fastWriteField6(buf []byte) (offset int) {
	...
	offset += fastpb.WriteMessage(buf[offset:], 6, x.GetPayment())
	return offset
}
...
func (x *CheckoutReq) fastWriteField7(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt32(buf[offset:], 7, int32(x.GetPaymentType()))
	return offset
}
...
func (x *PaymentInfo) sizeField1() (n int) {
	...
	n += fastpb.SizeInt32(1, int32(x.GetPaymentType()))
	return n
}
...
func (x *PaymentInfo) sizeField3() (n int) {
	...
	n += fastpb.SizeString(3, x.GetAlipayAuthCode())
	return n
}
...
func (x *CheckoutReq) sizeField6() (n int) {
	...
	n += fastpb.SizeMessage(6, x.GetPayment())
	return n
}
...
func (x *CheckoutReq) sizeField7() (n int) {
	...
	n += fastpb.SizeInt32(7, int32(x.GetPaymentType()))
	return n
}
