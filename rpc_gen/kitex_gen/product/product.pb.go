...
type UpdateProductReq struct {
	...
	Picture     string  `protobuf:"bytes,4,opt,name=picture,proto3" json:"picture,omitempty"` // 存储图片的URL或服务器上的路径
...
type ListProductsResp struct {
	...
	CategoryDesc string     `protobuf:"bytes,2,opt,name=categoryDesc,proto3" json:"categoryDesc,omitempty"`
}
...
func (x *ListProductsResp) GetCategoryDesc() string {
	if x != nil {
...
type CreateProductReq struct {
	...
	Picture     string  `protobuf:"bytes,3,opt,name=picture,proto3" json:"picture,omitempty"` // 存储图片的URL或服务器上的路径
...
func (x *CreateProductReq) GetCategoryId() uint32 {
	if x != nil {
		return x.CategoryId
	}
	return 0
...
type CreateProductResp struct {
	...
	Product *Product `protobuf:"bytes,1,opt,name=product,proto3" json:"product,omitempty"`  // 返回新创建的商品信息
	Success bool     `protobuf:"varint,2,opt,name=success,proto3" json:"success,omitempty"` // 成功状态标识
	Message string   `protobuf:"bytes,3,opt,name=message,proto3" json:"message,omitempty"`  // 错误或成功信息
}
...
var file_product_proto_rawDesc = []byte{
	...
	0x07, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x22, 0x88, 0x01, 0x0a, 0x10, 0x55, 0x70, 0x64,
	...
	0x69, 0x63, 0x65, 0x22, 0x3f, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f,
	...
	0x74, 0x65, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x52, 0x65, 0x73, 0x70, 0x22, 0x65, 0x0a,
	...
	0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x22, 0x64, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x72,
	...
	0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x12, 0x22, 0x0a, 0x0c, 0x63, 0x61, 0x74, 0x65,
	0x67, 0x6f, 0x72, 0x79, 0x44, 0x65, 0x73, 0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c,
	0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x44, 0x65, 0x73, 0x63, 0x22, 0x1f, 0x0a, 0x0d,
	...
	0x07, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x22, 0x99, 0x01, 0x0a, 0x10, 0x43, 0x72, 0x65,
	...
	0x72, 0x79, 0x49, 0x64, 0x22, 0x73, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x72,
	...
	0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xca, 0x03, 0x0a, 0x15, 0x50, 0x72,
	...
	0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x48, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61,
	...
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x65, 0x69, 0x6c, 0x69, 0x6e, 0x67, 0x6c, 0x75, 0x6f, 0x6c,
	0x69, 0x6e, 0x67, 0x6c, 0x75, 0x6f, 0x2f, 0x67, 0x6f, 0x6d, 0x61, 0x6c, 0x6c, 0x2f, 0x72, 0x70,
...
var file_product_proto_goTypes = []interface{}{
	(*UpdateProductReq)(nil),   // 0: product.UpdateProductReq
	(*UpdateProductResp)(nil),  // 1: product.UpdateProductResp
	(*DeleteProductReq)(nil),   // 2: product.DeleteProductReq
	(*DeleteProductResp)(nil),  // 3: product.DeleteProductResp
...
var file_product_proto_depIdxs = []int32{
	5,  // 0: product.UpdateProductResp.product:type_name -> product.Product
	5,  // 1: product.ListProductsResp.products:type_name -> product.Product
	5,  // 2: product.GetProductResp.product:type_name -> product.Product
	5,  // 3: product.SearchProductsResp.results:type_name -> product.Product
	5,  // 4: product.CreateProductResp.product:type_name -> product.Product
	4,  // 5: product.ProductCatalogService.ListProducts:input_type -> product.ListProductsReq
	7,  // 6: product.ProductCatalogService.GetProduct:input_type -> product.GetProductReq
	9,  // 7: product.ProductCatalogService.SearchProducts:input_type -> product.SearchProductsReq
	11, // 8: product.ProductCatalogService.CreateProduct:input_type -> product.CreateProductReq
	2,  // 9: product.ProductCatalogService.DeleteProduct:input_type -> product.DeleteProductReq
	0,  // 10: product.ProductCatalogService.UpdateProduct:input_type -> product.UpdateProductReq
	6,  // 11: product.ProductCatalogService.ListProducts:output_type -> product.ListProductsResp
	...
	12, // 14: product.ProductCatalogService.CreateProduct:output_type -> product.CreateProductResp
	3,  // 15: product.ProductCatalogService.DeleteProduct:output_type -> product.DeleteProductResp
	1,  // 16: product.ProductCatalogService.UpdateProduct:output_type -> product.UpdateProductResp
