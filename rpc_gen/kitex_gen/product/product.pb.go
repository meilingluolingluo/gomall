...
type ListProductsReq struct {
	...
	Page         int32  `protobuf:"varint,1,opt,name=page,proto3" json:"page,omitempty"`                // 请求的页码
	PageSize     int64  `protobuf:"varint,2,opt,name=pageSize,proto3" json:"pageSize,omitempty"`        // 每页显示的产品数量
	CategoryName string `protobuf:"bytes,3,opt,name=categoryName,proto3" json:"categoryName,omitempty"` // 所属的产品分类名称
}
...
type Product struct {
	...
	Id          uint32   `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`                  // 产品的唯一标识符
	...
	Picture     string   `protobuf:"bytes,4,opt,name=picture,proto3" json:"picture,omitempty"`         // 产品图片URL
	Price       float32  `protobuf:"fixed32,5,opt,name=price,proto3" json:"price,omitempty"`           // 产品价格
	Categories  []string `protobuf:"bytes,6,rep,name=categories,proto3" json:"categories,omitempty"`   // 产品分类列表（一个商品属于多个类别）
}
...
type ListProductsResp struct {
	...
	Products []*Product `protobuf:"bytes,1,rep,name=products,proto3" json:"products,omitempty"` // 返回的产品列表
}
...
type GetProductReq struct {
	...
	Id uint32 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"` // 要获取的产品的唯一标识符
}
...
type GetProductResp struct {
	...
	Product *Product `protobuf:"bytes,1,opt,name=product,proto3" json:"product,omitempty"` // 返回的产品信息
}
...
type SearchProductsResp struct {
	...
	Results []*Product `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"` // 搜索到的产品列表
}
...
var file_product_proto_rawDesc = []byte{
	...
	0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x3f,
	0x5a, 0x3d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x65, 0x69,
	0x6c, 0x69, 0x6e, 0x67, 0x6c, 0x75, 0x6f, 0x6c, 0x69, 0x6e, 0x67, 0x6c, 0x75, 0x6f, 0x2f, 0x67,
