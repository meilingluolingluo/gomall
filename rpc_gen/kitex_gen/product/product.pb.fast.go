...
func (x *ListProductsResp) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.CategoryDesc, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}
...
func (x *ListProductsReq) fastWriteField9(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt32(buf[offset:], 9, x.GetPageSize())
	return offset
}
...
func (x *ListProductsResp) fastWriteField2(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 2, x.GetCategoryDesc())
	return offset
}
...
func (x *CreateProductReq) fastWriteField5(buf []byte) (offset int) {
	...
	offset += fastpb.WriteUint32(buf[offset:], 5, x.GetCategoryId())
	return offset
}
...
func (x *ListProductsReq) sizeField9() (n int) {
	...
	n += fastpb.SizeInt32(9, x.GetPageSize())
	return n
}
...
func (x *ListProductsResp) sizeField2() (n int) {
	...
	n += fastpb.SizeString(2, x.GetCategoryDesc())
	return n
}
...
func (x *CreateProductReq) sizeField5() (n int) {
	...
	n += fastpb.SizeUint32(5, x.GetCategoryId())
	return n
}
